...
parser.add_argument('--height',             default=300,     required=True,  type=int)
parser.add_argument('--width',              default=300,     required=True,  type=int)
...
if __name__ == '__main__':
    ...
    context = vars(args)
    context['fine_tune_checkpoint'] = f'STAGE1/icnet_{args.width:04d}x{args.height:04d}_{args.filter_scale:02.2f}/comp/pruned_model.ckpt'
    context['crop_height'] = args.height + 1
    context['crop_width']  = args.width  + 1
    context['eval_height'] = args.height + 1
    context['eval_width']  = args.width  + 1
    ...
    CONF_NAME_FOR_1ST_STAGE = f'icnet_1st_{args.width:04d}x{args.height:04d}_{args.filter_scale:02.2f}.conf'
    CONF_NAME_FOR_2ND_STAGE = f'icnet_2nd_{args.width:04d}x{args.height:04d}_{args.filter_scale:02.2f}.conf'
    CMD_NAME                = f'cmds_for_{args.width:04d}x{args.height:04d}_{args.filter_scale:02.2f}.txt'
    ...
    context={
        ...
        'train_tag'    : f'icnet_{args.width:04d}x{args.height:04d}_{args.filter_scale:02.2f}',
        'shape'        : f'-1,{args.width},{args.height},3',
